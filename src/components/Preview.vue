...
<template>
  <div class="mobile_preview_component">
    <div
      v-if="showTopBar"
      class="mobile_preview_top_bar clearfix"
    >
      <div
        class="mobile_preview_top_bar_back left"
        @click="goBack"
      >
        返回
      </div>
    ...
    <iframe
      v-if="type === 'iframe'"
      :class="{'no_top_bar': !showTopBar}"
      :src="url"
      class="mobile_preview_iframe"
      height="610"
      width="360"
    ></iframe>
    <div
