...
import { mdiAccount, mdiBackburger, mdiClose, mdiDotsVertical, mdiForwardburger, mdiLogout, mdiMenu } from "@mdi/js";
...
const titleStack = ref(["Admin", "Dashboard", "good"]);
...
<template>
  <nav
    ...
    class="top-0 left-0 right-0 fixed flex bg-white h-14 border-b z-[100] w-screen
  ...
  >
    <div class="flex-1 items-stretch flex h-14">
      ...
      <nav-bar-item>
        <title-bar class="hidden lg:block" />
        <!--                <nav-bar-search />-->
      </nav-bar-item>
    </div>
      ...
      >
        ...
        <nav-bar-menu has-divider>
          ...
          <template #dropdown>
            ...
            <!--              />-->
            <!--            </nav-bar-item>-->
            <!--            &lt;!&ndash;            <nav-bar-item to="profile">&ndash;&gt;-->
            <!--            &lt;!&ndash;              <nav-bar-item-label&ndash;&gt;-->
            <!--            &lt;!&ndash;                :icon="mdiAccount"&ndash;&gt;-->
            <!--            &lt;!&ndash;                label="My Profile"&ndash;&gt;-->
            <!--            &lt;!&ndash;              />&ndash;&gt;-->
            <!--            &lt;!&ndash;            </nav-bar-item>&ndash;&gt;-->
            <!--            <nav-bar-item>-->
            <!--              <nav-bar-item-label-->
            <!--                :icon="mdiCogOutline"-->
            <!--                label="Settings"-->
            ...
            <divider nav-bar />
            <nav-bar-item
              @click="$router.push({name: 'updatePassword'})"
            >
              <nav-bar-item-label
                :icon="mdiAccount"
                label="账户信息"
