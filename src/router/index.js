    ...
    children: [
      {
        ...
        path: "overview",
        name: "overview",
        component: () => import("@/views/dataOverview/Home.vue")
      },
      {
        meta: {
          id: 3,
        ...
        path: "regionalHorizontalComparison",
        name: "regionalHorizontalComparison",
        component: () =>
          import("@/views/dataOverview/RegionalHorizontalComparison.vue")
      },
      {
        meta: {
          id: 4,
